...
def PID(roll, pitch, yaw, f):
	...
	return [fr_motor_vel,-fl_motor_vel,bl_motor_vel, -br_motor_vel]
...
def callback(msg):
	...
	orientationObj = msg.pose.pose.orientation
	...
	motor_commands.angular_velocities.append(fUpdated[0])
	motor_commands.angular_velocities.append(fUpdated[1])
	motor_commands.angular_velocities.append(fUpdated[2])
	motor_commands.angular_velocities.append(fUpdated[3])
...
velPub = rospy.Publisher('/pelican/command/motor_speed', Actuators, queue_size=1)
